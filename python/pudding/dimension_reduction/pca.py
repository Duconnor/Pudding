...
def pca(X, n_components=None):
    ...
    Besides that, this function also performs reconstruction using the obtained principal components.
    ...
    Return: a tuple of (principal_components, principal_axes, variances, reconstructed_X)
    '''
    ...
    c_pca_reduction(np_X, n_samples, n_features, n_components, variance_percentage, np_principal_components, np_principal_axes, np_variance, np_reconstructed_X, ctypes.byref(c_n_components_chosen))
    ...
    return (np_principal_components.tolist(), np_principal_axes.tolist(), np_variance.tolist(), np_reconstructed_X.tolist())
